        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-7xl mx-auto">
            {[
              ...
              { icon: Sparkles,      title: "Summarize Document",      description: "Compress and extract a smart AI summary from any PDF or DOCX.", features: ["Powered by Llama 3", "SlimFile compression", "Structured output"],           gradient: "from-purple-600 to-indigo-700", href: "/summarize",      badge: "AI" },
            ].map((feature) => (
