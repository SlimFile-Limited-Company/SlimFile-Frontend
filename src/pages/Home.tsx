...
const getApiBase = () => {
  // ✅ Use environment variable set in Vercel, fallback to Render backend
  ...
  return (
    <div className="min-h-screen pt-5">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
        ...
        {/* iPhone Mockups with Compression Animations */}
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            {/* Trust Badge with Morphing Animation */}
            <motion.div
            ...
            >
              ...
              {/* Featured on BetaList Badge - Styled like Trust Badge */}
              <motion.div
...
>
  Reduce file sizes instantly without compromising quality. Fast, secure, and completely free compression for images, PDFs, and PPTX.
            ...
            {/* Buttons with Advanced Hover Animations */}
            <motion.div
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto">
          ...
          >
            {[
              { value: 7000, suffix: "+", label: "Files Compressed", icon: FileImage, color: "red" },
