...
export default function OurBlogs() {
  ...
  return (
    <div className="min-h-screen pt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {featuredPosts.map((post) => {
                ...
                return (
                  <div
                    key={post.id}
                    className={`bg-gradient-to-br ${post.gradient} rounded-xl p-6 border-2 border-gray-200 hover:border-purple-300 transition-all duration-300 hover:shadow-lg`}
                  >
                    <div className="flex items-start mb-4">
                      <div className={`flex items-center justify-center w-12 h-12 rounded-full ${post.bgColor} mr-4`}>
                        <IconComponent className={`w-6 h-6 ${post.iconColor}`} />
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {regularPosts.map((post) => {
              ...
              return (
                <div
                  key={post.id}
                  className={`bg-gradient-to-br ${post.gradient} rounded-xl p-6 border-2 border-gray-200 hover:border-gray-300 transition-all duration-300 hover:shadow-lg`}
                >
                  <div className="flex items-start mb-4">
                    <div className={`flex items-center justify-center w-10 h-10 rounded-full ${post.bgColor} mr-3`}>
                      <IconComponent className={`w-5 h-5 ${post.iconColor}`} />
                    </div>
                    <div className="flex-1">
      ...
      {/* Call to Action */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-600 to-red-700">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/compress">
              <Button size="lg" className="bg-white text-red-600 hover:bg-gray-100 px-8 py-3 rounded-lg font-semibold">
                <Upload className="w-5 h-5 mr-2" />
                Start Compressing
              </Button>
            </Link>
            <Link to="/api">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-red-600 px-8 py-3 rounded-lg font-semibold">
