  ...
  const columns = [
    {
      heading: "Tools",
      links: [
        { label: "Compress PDF", path: "/compress-pdf-online" },
        { label: "Compress Images", path: "/compress-images-online" },
        { label: "Compress PPTX", path: "/compress-pptx-online" },
        { label: "OCR Tool", path: "/ocr-tool" },
        { label: "AI Summarizer", path: "/summarize" },
        { label: "SlimFile Forge", path: "/forge" },
        { label: "Lock / Unlock PDF", path: "/lock" },
        { label: "Convert Files", path: "/convert-only" },
        { label: "Convert & Compress", path: "/convert-compress" },
      ],
    },
    {
      heading: "Company",
    ...
    },
    {
      heading: "Community",
      links: [
        { label: "Global Dashboard", path: "/global-dashboard" },
